...
return [
    ...
    */
    ...
    'watchers' => [
        ...
        // CRITICAL: Database Query Monitoring for Failover System
        Watchers\QueryWatcher::class => [
            'enabled' => env('TELESCOPE_QUERY_WATCHER', true),
            'ignore_packages' => true,
            'ignore_paths' => [],
            'slow' => env('TELESCOPE_SLOW_QUERY_THRESHOLD', 100), // Log queries slower than 100ms
        ],

        Watchers\RedisWatcher::class => env('TELESCOPE_REDIS_WATCHER', true),

        // CRITICAL: Request Monitoring for Failover Impact Analysis
        ...
        // Custom Database Failover Watcher (will be implemented)
        // \Shared\Telescope\DatabaseFailoverWatcher::class => [
        //     'enabled' => env('TELESCOPE_FAILOVER_WATCHER', true),
        // ],
    ],
];
