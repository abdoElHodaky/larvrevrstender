...
class UserServiceTest extends TestCase
{
    ...
    public function it_validates_national_id_format()
    {
        ...
        foreach ($validIds as $id) {
            $this->assertTrue((bool) preg_match('/^\d{10}$/', $id), "National ID '$id' should be valid");
        }
        ...
        foreach ($invalidIds as $id) {
            $this->assertFalse((bool) preg_match('/^\d{10}$/', $id), "National ID '$id' should be invalid");
        }
    }
    ...
    public function it_validates_commercial_registration_format()
    {
        ...
        foreach ($validCRs as $cr) {
            $this->assertTrue((bool) preg_match('/^CR\d{9}$/', $cr), "Commercial registration '$cr' should be valid");
        }
        ...
        foreach ($invalidCRs as $cr) {
            $this->assertFalse((bool) preg_match('/^CR\d{9}$/', $cr), "Commercial registration '$cr' should be invalid");
        }
    }
    ...
    public function it_validates_vat_number_format()
    {
        ...
        foreach ($validVATs as $vat) {
            $this->assertTrue((bool) preg_match('/^VAT\d{9}$/', $vat), "VAT number '$vat' should be valid");
        }
        ...
        foreach ($invalidVATs as $vat) {
            $this->assertFalse((bool) preg_match('/^VAT\d{9}$/', $vat), "VAT number '$vat' should be invalid");
        }
    }
    ...
    public function it_validates_vin_format()
    {
        ...
        foreach ($validVINs as $vin) {
            $this->assertTrue((bool) preg_match('/^[A-HJ-NPR-Z0-9]{17}$/', $vin), "VIN '$vin' should be valid");
        }
        ...
        foreach ($invalidVINs as $vin) {
            $this->assertFalse((bool) preg_match('/^[A-HJ-NPR-Z0-9]{17}$/', $vin), "VIN '$vin' should be invalid");
        }
    }
