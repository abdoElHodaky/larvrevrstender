    ...
    */
    ...
    'connections' => [
        ...
        'pgsql' => [
            ...
            'database' => env('NEON_DB_DATABASE', env('DB_DATABASE', 'reverse_tender_users')),
        ...
        'pgsql_secondary' => [
            ...
            'database' => env('CLOUD_DB_DATABASE', 'reverse_tender_users'),
        ...
        'mongodb' => [
            ...
            'database' => env('MONGO_DB_DATABASE', 'reverse_tender_users'),
