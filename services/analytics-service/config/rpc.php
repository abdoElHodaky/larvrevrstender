...
return [
    ...
    */
    'services' => [
        ...
        'payment' => [
            'url' => env('RPC_PAYMENT_SERVICE_URL', env('PAYMENT_SERVICE_URL', 'http://payment-service:8080') . '/rpc'),
            'token' => env('RPC_PAYMENT_SERVICE_TOKEN', ''),
        ],
        'auction' => [
            'url' => env('RPC_AUCTION_SERVICE_URL', env('AUCTION_SERVICE_URL', 'http://auction-service:8080') . '/rpc'),
            'token' => env('RPC_AUCTION_SERVICE_TOKEN', ''),
        ],
        'bidding' => [
