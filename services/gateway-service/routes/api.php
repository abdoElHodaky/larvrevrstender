...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // Note: Business logic routes have been removed from gateway
    // Use the service routing instead:
    // - User management: /services/user-service/users/*
    // - Permissions: /services/auth-service/permissions/*
    // - Roles: /services/auth-service/roles/*
    // - Activities: /services/logging-service/activities/*
});
