...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        // Write Operation Events (CRITICAL for auction service)
        ...
        'App\Events\AuctionCreated' => [
            'App\Listeners\NotifyAuctionCreated',
            'App\Listeners\LogAuctionActivity',
        ],

        'App\Events\BidPlaced' => [
            'App\Listeners\NotifyBidPlaced',
            'App\Listeners\UpdateAuctionMetrics',
            'App\Listeners\LogBidActivity',
        ],

        'App\Events\AuctionEnded' => [
            'App\Listeners\ProcessAuctionEnd',
            'App\Listeners\NotifyAuctionEnd',
            'App\Listeners\LogAuctionCompletion',
        ],
    ];
