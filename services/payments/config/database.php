    ...
    */
    ...
    'connections' => [
        ...
        'pgsql' => [
            ...
            'database' => env('NEON_DB_DATABASE', env('DB_DATABASE', 'reverse_tender_payments')),
            'username' => env('NEON_DB_USERNAME', env('DB_USERNAME', 'payment_user')),
        ...
        'pgsql_secondary' => [
            ...
            'database' => env('CLOUD_DB_DATABASE', 'reverse_tender_payments'),
            'username' => env('CLOUD_DB_USERNAME', 'payment_user'),
        ...
        'mongodb' => [
            ...
            'database' => env('MONGO_DB_DATABASE', 'reverse_tender_payments'),
